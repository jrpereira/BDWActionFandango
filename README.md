...
- [ModCoreTemplates](https://www.nexusmods.com/thebloodofdawnwalker/mods/641),
  with support for Fangdango's **Wheels** option.
...
1. Close the game completely. Extract the mod download so its `Fangdango`
...
3. Ensure the mods are enabled in your UE4SS setup or mod manager, then restart
   the game. Avoid an extra nested `Fangdango/Fangdango` folder.
